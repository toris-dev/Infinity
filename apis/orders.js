...
router.post('/', asyncHandler(async (req, res) => {
    ...
    console.log(newOrderProds);
    await Orders.create({ orderId, orderProds: newOrderProds, orderDate, orderAddress, orderDetailAddress, orderZipCode, orderName, orderPhoneNum, orderReq, orderState});
