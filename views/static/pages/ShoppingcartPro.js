                ...
                <div class="cart_product">
                    <table class="cart_table">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr class="tr2">
                                    <td colspan="3" class="tr2_td1"><div class="product_infor"><input type="checkbox" id="checkbox2"/><img src="../images/플렌티 스웻 펜츠.jpg" class="img"> <p>[자체제작] 플렌티 스웻 팬츠</p></div></td>
                                    <td><input type='button' class="plus" onclick='count("plus")' value='+'/>
                                        <input type='button' class="minus" onclick='count("minus")' value='-'/>
                                        <div id='result'>0</div></td>
                                    <td>₩42800</td>
                                    <td>기본배송</td>
                                    <td>무료</td>
                                    <td>
                                ...
                                <tr class="tr3">
                                    ...
                                    <td class="tr3_td2" colspan="6">상품구매금액 42800+배송비0 = 42800</td>
                                </tr>
                            </tbody>
                        </th>
                    </table>
                    <p class="discount_guide">❗️ 할인 적용 금액은 주문서작성의 결제예정금액에서 확인 가능합니다</p>
                    <hr/ width="100%">
                    <h2 style="font-size: 15px;">선택상품을<a href="#" class="delete_product" style="margin: 0 0 5px 15px;">삭제하기</a></h2>
